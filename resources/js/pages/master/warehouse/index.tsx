...
import { deleteMethod, save } from '@/routes/master/warehouse';
...
export default function Index({ warehouses, filters, stats }: Props) {
    ...
    const isEdit = selectedWarehouse !== null;
    ...
    const handleDelete = () => {
        ...
        router.delete(deleteMethod(selectedWarehouse.id).url, {
            preserveScroll: true,
            onSuccess: () => {
                setOpenDelete(false);
                setSelectedWarehouse(null);
        ...
        <div className="space-y-6 p-6">
            ...
            <DataTable>
                <div className="border-b p-5">
                    <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                                {warehouses.total} records found
                            </p>
                        </div>
                ...
                <div className="flex flex-col gap-3 border-t p-4 md:flex-row md:items-center md:justify-between">
                    <p className="text-sm text-muted-foreground">
                        Showing page {warehouses.current_page} of{' '}
