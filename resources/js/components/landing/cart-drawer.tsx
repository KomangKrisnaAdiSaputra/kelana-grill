  ...
  return (
    <div className="fixed inset-0 z-[999]">
      ...
      <div className="absolute inset-y-0 right-0 flex w-full justify-end sm:p-4">
        <div
          className={`
            relative flex h-full w-full max-w-md flex-col overflow-hidden
            ...
            {cartItems.length ===
              ...
              <div className="flex h-full flex-col items-center justify-center text-center">
                ...
                <p
                  ...
                  `}
                >
                  {__("Tambahkan produk favoritmu ke dalam keranjang.")}
                </p>
              </div>
            ) : (
                ...
                {cartItems.map(
                  (item) => (
                    <div
                      ...
                      className={`
                        overflow-hidden rounded-[28px] border p-4 transition-all duration-300
                        ${theme === "dark"
                          ? `
                                border-white/10
                                bg-white/[0.03]
          ...
          {cartItems.length >
            0 && (
              ...
              >
                ...
                <button
                  className="
                  mt-5 flex h-12 w-full items-center justify-center
