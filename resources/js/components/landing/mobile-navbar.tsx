...
export default function MobileNavbar({ theme }: Props) {
    ...
    return (
        <div
            className={`fixed bottom-4 left-1/2 z-40 w-[calc(100%-20px)] max-w-md -translate-x-1/2 rounded-[28px] border px-3 py-3 backdrop-blur-2xl xl:hidden ${
                theme === 'dark'
                ...
                {mobileItems.map((item) => {
                    ...
                    return (
                        <a
                            ...
                            className={`rounded-2xl py-2 text-center text-xs font-semibold transition ${
                                isActive
                                    ? theme === 'dark'
